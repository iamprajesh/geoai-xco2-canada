...
1. **temperature_2m** (K): 2-meter air temperature
2. **total_precipitation_sum** (m): Daily total precipitation
3. **u_component_of_wind_10m** (m/s): Eastward wind component at 10m
4. **v_component_of_wind_10m** (m/s): Northward wind component at 10m
5. **surface_pressure** (Pa): Surface atmospheric pressure
6. **dewpoint_temperature_2m** (K): 2-meter dewpoint temperature
...
2. **slope** (degrees): Terrain slope derived from elevation
